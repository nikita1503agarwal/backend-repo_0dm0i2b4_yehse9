...
# Arivar lead/contact schema
class Lead(BaseModel):
    """
    Leads collected from the website contact or demo request forms
    ...
    product_interest: Optional[str] = Field(None, description="Which product they are interested in")
